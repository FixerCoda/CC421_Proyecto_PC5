...
Cada componente resume una propiedad relevante del tablero después de colocar una pieza. Sea $h_j$ la altura de la columna $j$ y $W$ el número de columnas.
...
El número de líneas eliminadas después de colocar una pieza se define como:
