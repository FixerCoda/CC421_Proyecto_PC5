...
A partir de la Tabla~\ref{tab:sweep_gamma}, se observa que $\gamma=0.999$ obtiene el mayor promedio, el mayor valor máximo y la menor dispersión, por lo que es el más robusto. En contraste, $\gamma=0.900$ prácticamente no aprende (promedio de $10.71$ líneas): un horizonte demasiado corto impide valorar la supervivencia a largo plazo, esencial en Tetris.
