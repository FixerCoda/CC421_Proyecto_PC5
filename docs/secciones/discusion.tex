...
La tasa de aprendizaje también mostró un efecto importante. El mejor resultado se obtuvo con $\alpha=0.0005$, mientras que $\alpha=0.001$ resultó la menos estable en promedio. Esto indica que una tasa demasiado alta acelera la adaptación de los pesos pero aumenta el riesgo de inestabilidad, y que un valor intermedio ofrece el mejor equilibrio entre velocidad y estabilidad. Por ello, el mejor resultado surge de una interacción favorable entre $\alpha=0.0005$, $\gamma=0.999$ y $N_{\varepsilon}=1500$.
